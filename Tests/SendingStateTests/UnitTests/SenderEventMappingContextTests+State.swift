...
//  SendingState
//
//  Created by SunSoo Jeon on 2023/11/26.
//
...
extension SenderEventMappingContextTests {
    ...
    func test_control_state_returns_typed_state_at_event_time() {
        ...
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.control(.touchUpInside) { (state: TestConfigurableUIView.Model) in
    ...
    func test_gesture_state_resolves_correctly() {
        ...
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.gesture(gestureEvent) { (state: TestConfigurableUIView.Model) in
            [.custom(state.text)]
        }
    ...
    func test_tapGesture_state_creates_correct_event_key() {
        ...
        // When
        let ctx = SenderEventMappingContext(sender: view)
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.tapGesture { (state: String) in
            [.custom(state)]
        }
    ...
    func test_longPressGesture_state_overload() {
        ...
        // When
        let ctx = SenderEventMappingContext(sender: view)
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.longPressGesture { (state: Int) in
            [.buttonTapped(state)]
        }
    ...
    func test_swipeGesture_state_overload() {
        ...
        // When
        let ctx = SenderEventMappingContext(sender: view)
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.swipeGesture(direction: .left) { (state: String) in
            [.custom(state)]
        }
    ...
    func test_panGesture_state_overload() {
        ...
        // When
        let ctx = SenderEventMappingContext(sender: view)
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.panGesture { (state: String) in
            [.custom(state)]
        }
    ...
    func test_pinchGesture_state_overload() {
        ...
        // When
        let ctx = SenderEventMappingContext(sender: view)
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.pinchGesture { (state: String) in
            [.custom(state)]
        }
    ...
    func test_rotationGesture_state_overload() {
        ...
        // When
        let ctx = SenderEventMappingContext(sender: view)
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.rotationGesture { (state: String) in
            [.custom(state)]
        }
    ...
    func test_screenEdgeGesture_state_overload() {
        ...
        // When
        let ctx = SenderEventMappingContext(sender: view)
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.screenEdgeGesture(edges: .right) { (state: String) in
            [.custom(state)]
        }
    ...
    func test_hoverGesture_state_overload() {
        ...
        // When
        let ctx = SenderEventMappingContext(sender: view)
        let mapping: [SenderEvent: () -> [TestAction]] = ctx.hoverGesture { (state: String) in
            [.custom(state)]
        }
    ...
    func test_state_and_stateless_overloads_coexist_in_builder() {
        ...
        let forwarder = EventForwarder(button) { _, ctx in
            ...
            ctx.control(.touchUpInside) { (state: TestConfigurableUIView.Model) in
